/*
Problem Statement: Binary Tree Traversals and Basic Operations

Given a binary tree represented as a preorder array with -1 indicating null nodes, implement the following:

1. Build the binary tree from the preorder array.
2. Print the tree in preorder including -1 for null nodes.
3. Perform standard tree traversals: preorder, inorder, postorder.
4. Print level order traversal line by line.
5. Calculate and return:
   - Height of tree (in nodes and edges)
...
Example Output:
Print Original array with the help of root: 1 2 4 -1 -1 5 -1 -1 3 -1 6 -1 -1 
