/*
Problem Statement: Invert (Mirror) Binary Tree

Given a binary tree, invert it so that the left and right children of all nodes are swapped, effectively creating the mirror image of the tree.
...
- The structure of the tree is mirrored along its root.
*/
