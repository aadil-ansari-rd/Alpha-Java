...
Given a binary tree, delete all leaf nodes that have a specific value x.  
A leaf node is defined as a node with no children. After deletion, print the inorder traversal of the updated tree.
...
Example Output:
Inorder before deletion: 2 1 2 3 4
Inorder after deletion: 1 3 4

Explanation:
- Leaf nodes with value 2 are deleted.
- Node with value 2 that is a leaf under the right child 3 is removed.
- The inorder traversal reflects the updated tree structure.
*/
