/*
Problem Statement: LeetCode 652 - Find Duplicate Subtrees

Given a binary tree, return all duplicate subtrees.  
For each kind of duplicate subtree, you only need to return the root node of any one of them. Two trees are considered duplicate if they have the same structure and node values.
...
Example Output:
Duplicate Subtrees Inorder Traversal:
4
2 4
4

Explanation:
- The tree has duplicate subtrees with root values 4 and 2.
- Each duplicate subtree is printed once using its inorder traversal.
*/
