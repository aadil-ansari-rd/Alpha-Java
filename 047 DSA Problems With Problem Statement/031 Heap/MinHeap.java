/*
Problem Statement: Implement Min Heap using ArrayList

✅ Problem Statement:
Design and implement a Min Heap data structure using an ArrayList in Java. The Min Heap should support the following operations:

1. add(int data) — Inserts an element into the heap.
2. peek() — Returns the minimum element without removing it.
3. remove() — Removes and returns the minimum element from the heap.
4. isEmpty() — Checks if the heap is empty.

Example:
Input:
Operations: add(40), add(10), add(30), add(50), add(20), peek(), remove() repeatedly

Output:
Is heap empty? true
Minimum element (peek): 10
Heap elements in sorted (ascending) order: 10 20 30 40 50
Is heap empty after removals? true
*/
