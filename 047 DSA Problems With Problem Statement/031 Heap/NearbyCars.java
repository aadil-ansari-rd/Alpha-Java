/*
Problem Statement: K Closest Points to Origin (LeetCode L973)

✅ Problem Statement:
Given an array of points where points[i] = [x_i, y_i] represents a point on the X-Y plane and an integer k, return the k closest points to the origin (0, 0). The distance is calculated using Euclidean distance, but squared distance can be used for comparison.

Example:
Input: points = [[3,3],[5,-1],[-2,4]], k = 2
Output: [[3,3],[-2,4]]
Explanation: The closest two points to the origin are (3,3) and (-2,4). Order of points in output can vary.
*/
