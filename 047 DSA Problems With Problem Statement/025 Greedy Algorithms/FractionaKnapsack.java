...
Unlike 0/1 Knapsack, you are allowed to break items into smaller parts. 
The goal is to maximize the total value possible.
...
Output: 240.0
Explanation: 
Take the full items with weights 20 and 30, and 2/3 fraction of item with weight 10.
