/*
Problem Statement: Longest Word with All Prefixes

Given an array of words, find the longest word such that every prefix of the word is also present in the array. 
...
2. Use DFS to traverse Trie, only moving to children whose isEnd flag is true.
3. Keep track of the current path and update the result if the path is longer or lexicographically smaller.
4. Return the result after DFS completes.
*/
