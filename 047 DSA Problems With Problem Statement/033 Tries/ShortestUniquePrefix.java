/*
Problem: Shortest Unique Prefix (Trie)

Given an array of words, find the shortest unique prefix for each word such that no other word in the array has the same prefix.
...
- "dog" is uniquely identified by "dog"
- "duck" is uniquely identified by "du"
- "dove" is uniquely identified by "dov"
*/
