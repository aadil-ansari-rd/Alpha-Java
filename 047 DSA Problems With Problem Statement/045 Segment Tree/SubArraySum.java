/*
Problem: Range Sum Query (RSQ) using Segment Tree

Given an array arr[], build a segment tree to efficiently perform the following operations:

1. Query the sum of elements in a subarray [l, r].
...
Operations:
- Query sum in range [2,6] → Output: 25
- Update arr[3] = 10 → arr becomes [1,2,3,10,5,6,7,8]
- Query sum in range [2,6] → Output: 31
- Update arr[0] = 20 → arr becomes [20,2,3,10,5,6,7,8]
- Query sum in range [0,7] → Output: 61
*/
