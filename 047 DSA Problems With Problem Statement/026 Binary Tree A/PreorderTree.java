...
2. Print the preorder array (including -1 for null nodes) reconstructed from the tree.
3. Perform and print the following traversals of the tree:
   - Preorder Traversal
   - Inorder Traversal
   - Postorder Traversal
   - Level Order Traversal (line by line)
4. Compute and print:
   - Height of the tree in terms of nodes.
   - Height of the tree in terms of edges.
...
Example Output:
Print Original array with the help of root
