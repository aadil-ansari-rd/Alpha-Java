/*
Problem Statement: Bellman-Ford Algorithm for Single Source Shortest Path

Given a weighted directed graph with V vertices and E edges, find the shortest distances from a given source vertex to all other vertices. The graph may contain negative weight edges. If a negative weight cycle exists, report it.

Input:
- Number of vertices V
- Number of edges E
- Edge list: Each edge represented as (source, destination, weight)
- Source vertex for shortest paths

Output:
- Shortest distance from source to every vertex, or
- Indicate if a negative weight cycle exists
