/*
Problem Name: Advanced Custom Singly Linked List
------------------------------------------------
Problem Statement:
-----------------
Implement a custom singly linked list in Java with the following features:

1. Basic Operations:
   - addStart(int data) : Add element at the beginning.
   - addLast(int data) : Add element at the end.
   - addAtIndex(int data, int index) : Insert at a specific index.
   - removeStart() : Remove element from the start.
   - removeEnd() : Remove element from the end.
   - getSize() : Return current size of the list.
   - printList() : Print the linked list.

2. Searching:
   - itrSearch(int key) : Iteratively search for an element.
   - recSearch(int key) : Recursively search for an element.

3. Reversing:
   - reverse() : Iterative reversal.
   - reverse2() : Recursive reversal.

4. Special Operations:
   - deleteNthFromEnd(int n) : Delete nth node from end.
   - checkPallindrome() : Check if the linked list is a palindrome.
   - hasCycle() : Detect a cycle in the linked list.
   - removeCycle() : Remove a cycle in the linked list.
   - doMergeSort() : Sort the linked list using merge sort.
   - ZigZag() : Rearrange list in zig-zag pattern from both ends.
...
li.printList(); // Before ZigZag
li.ZigZag();
li.printList(); // After ZigZag
...
Notes:
------
- Tail is maintained for O(1) insertion at the end.
- Supports recursive and iterative implementations for key operations.
- Includes utility methods for palindrome check, cycle detection, merge sort, and zig-zag rearrangement.
*/
