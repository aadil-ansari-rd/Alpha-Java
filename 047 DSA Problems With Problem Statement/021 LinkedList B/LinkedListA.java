/*
Problem Name: Comprehensive Singly Linked List Implementation
-------------------------------------------------------------
Problem Statement:
-----------------
Implement a singly linked list in Java with the following functionalities:
...
2. LinkedList Operations:
   - Add elements:
     ...
     * addAtIndex(int data, int index) → Add element at a specific index.
   - Remove elements:
     * removeStart() → Remove element from the beginning.
     * removeEnd() → Remove element from the end.
   - Search for elements:
     * itrSearch(int key) → Iterative search for a value and return its index.
     * recSearch(int key) → Recursive search for a value and return its index.
   - Reverse linked list:
     * reverse() → Iterative reverse.
     * reverse2() → Recursive reverse.
   - Delete Nth node from the end.
   - Check if the linked list is a palindrome.
   - Utility methods:
     * getSize() → Return the size of the linked list.
     * printList() → Print all elements in the linked list.
     * findMidNode(Node head) → Return the middle node.

3. Example Usage:
   - Create linked list: 1 -> 2 -> 3 -> 2 -> 1 -> null
   - Check if the linked list is a palindrome → true
   - Print the linked list → 1 -> 2 -> 3 -> 2 -> 1 -> null

This implementation provides a comprehensive linked list with insertion, deletion, search, reversal, 
palindrome checking, and printing functionalities.
*/
