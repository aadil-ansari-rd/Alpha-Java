/*
✅ Java Program to Construct a Balanced BST from a Sorted Array

**Explanation**:
1. **Base Case**: `st > end` → return `null` (no elements left).
2. **Middle Element**: Pick middle element as root → ensures balanced tree.
3. **Recursion**: 
   - Left subtree → elements before mid
   - Right subtree → elements after mid
4. **Inorder Traversal**: Prints elements in sorted order, same as original array.

**Example**:
Input Array: [1,2,3,4,5,6,7,8,9]  
Inorder of BST: 1 2 3 4 5 6 7 8 9
*/
