/*
Mother Vertex Problem in Java:

1. Definition: A mother vertex in a directed graph is a vertex from which all other vertices are reachable.

2. Steps:
   - Step 1: Perform DFS for all vertices; track the last finished vertex as candidate.
   - Step 2: Perform DFS from candidate to verify if all vertices are reachable.
   - Step 3: If yes, candidate is mother vertex; else, no mother vertex exists (-1).
