...
1. Purpose: Finds the Minimum Spanning Tree (MST) of a weighted, undirected graph.

2. Steps:
   - Step 1: Sort all edges by weight in ascending order.
   - Step 2: Initialize Union-Find (Disjoint Set) to detect cycles.
   - Step 3: Pick edges one by one; include it if it doesn’t form a cycle.
   - Step 4: Stop when MST has n-1 edges.

3. Example:
Graph edges:
1-2 (1), 2-3 (2), 3-4 (3), 1-4 (4)

MST weight: 6 (edges 1-2, 2-3, 3-4)
*/
