...
1. Purpose: Finds all Strongly Connected Components (SCCs) in a directed graph.

2. Steps:
   - Step 1: DFS on original graph and push nodes onto a stack based on finish time.
   - Step 2: Transpose the graph (reverse all edges).
   - Step 3: DFS on transposed graph in stack order to get SCCs.
