/*
Problem Statement: Dijkstra's Shortest Paths from Source Using Edge Class

Given a weighted directed graph represented as a list of Edge objects (each with source, destination, and weight), compute the shortest distance from a given source node to all other nodes using Dijkstra's algorithm.
...
Input:
Vertices = 4
Edges = [(0,1,1),(0,2,5),(1,2,2),(1,3,6),(2,3,1)]
Source = 0
Output:
Node 0 -> 0
Node 1 -> 1
