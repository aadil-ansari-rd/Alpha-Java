/*
Problem Statement: Course Schedule II (LeetCode 210)

There are a total of numCourses courses you have to take, labeled from 0 to numCourses-1. Some courses may have prerequisites, given as a list of pairs [a, b] where b must be taken before a. Return the ordering of courses you should take to finish all courses. If it is impossible to finish all courses, return an empty array.
