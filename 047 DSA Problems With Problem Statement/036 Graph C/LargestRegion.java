/*
Problem Statement: Find the Largest Connected Region in a Binary Matrix

Given a 2D binary matrix (containing 0s and 1s), find the size of the largest connected region of 1s. Cells are connected if they are adjacent horizontally, vertically, or diagonally (8 directions).
...
Output: 5
Explanation: The largest region of connected 1s includes 5 cells.
...
Output: 1
Explanation: Each 1 is isolated, so the largest region has size 1.
*/
