/*
Problem Statement: Detect Cycle in Undirected Graph using BFS

Given an undirected graph represented as an adjacency list of edges (with source, destination, and weight), determine if the graph contains a cycle. Use Breadth-First Search (BFS) to detect cycles.

Example 1:
Input: Graph with edges [[0,1],[1,2],[2,3],[3,4],[4,1]]
Output: true
Explanation: The graph contains a cycle involving nodes 1-2-3-4-1.
